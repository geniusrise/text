...
from geniusrise_huggingface.classification.bulk import ClassificationBulk
import glob
import tempfile
...
MODELS_TO_TEST = {
    ...
    # "cardiffnlp/twitter-roberta-base-hate-latest": ["NOT_HATE", "HATE"],
    ...
    # "cardiffnlp/twitter-roberta-base-irony": ["non-irony", "irony"],
